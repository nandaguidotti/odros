...
<%
     ...
     HttpSession sessao = request.getSession();
       ...
       //String email_user = "jesimar.arantes@gmail.com";  // pegar do login para ficar parametrizável
       String email_user = usuario.getEmail_user();
       String nome_rota = "route-2018-05-11";   // criar um combo para pegar os nomes das rotas dos usuários vai pegar do login para ficar parametrizável
       ...
       // Essa consulta é apenas para teste
       //sql = "SELECT `lat`,`lng` FROM `logidronereal` WHERE `email_user` = '" + email_user + "';";
...
out.println("function initMap() {");
   ...
   out.println("];");
    ...
    out.println("<script async defer "
            + "src=\"https://maps.googleapis.com/maps/api/js?key=AIzaSyBWsnyVR-qFkfP1O4REGbdlAztM_9uPbGo&callback=initMap\">");               
    out.println("</script>");
