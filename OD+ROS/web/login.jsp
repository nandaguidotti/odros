    ...
    <div class="container">
      <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down">
          ...
          <li>
            <a href="index.jsp#pesquisa">Pesquisa</a>
          </li>
          <li>
            <a href="index.jsp#mineracao">Mineração</a>
          </li>
          <li>
            <a href="index.jsp#fotos">Fotos</a>
          </li>
          <li>
...
<ul class="sidenav" id="mobile-nav">
  ...
  <li>
    <a href="index.jsp#mineracao">Rotas Favoritas</a>
  </li>
  <li>
    <a href="index.jspindex.jsp#fotos">Fotos</a>
  </li>
  <li>
    <a href="index.jsp#contato">Contato</a>
  </li>
