...
<!--
  <script type="text/javascript">
    var pontosLat = [];
    function setPontosLat(p){
      pontosLat = p;
    }
    var pontosLong = [];
    function setPontosLong(p){
      pontosLong = p;
    }
    
   function initMap(){
      var div = $("#signup-inner");
      div.empty();
      div.append("<div id='map'></div>")

      var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 18,
          center: {lat: -22.006243, lng: -47.898435},
          mapTypeId: 'satellite'
      });
      ...
      for (var i = 0; i < pontosLat.length; i++) {
          var lat_lng = {};
          lat_lng["lat"] = pontosLat[i];
          lat_lng["lng"] = pontosLong[i];
          locations.push(lat_lng,lat_lng,lat_lng,lat_lng);
      }
  ...
  <script async defer src=https://maps.googleapis.com/maps/api/js?key=AIzaSyAuFq5j0XisThfVc34csR7AyBndr_vEEl0&callback=initMap></script>-->
