...
public class Usuario {
 ...
 public boolean logar() throws SQLException{
        ...
        /*
        System.out.println(getName_user());       
        System.out.println(getEmail_user());       
        System.out.println(getYearb_user());       
        System.out.println(getPass_user());    
        */
...
/*
        ...
        System.out.println(getYearb_user());       
        System.out.println(getPass_user());       
        System.out.println(getCountry_user());       
 */      
        ps = banco.conn.prepareStatement(sql);
